...
BuilderWorld.terrainScript = "$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Scripts/ChallengeModeScripts/challenge/terrain_challengebuilder.lua"
--BuilderWorld.terrainScript = "$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Scripts/Core/terrain.lua"
...
function BuilderWorld.server_export( self, data )
	...
	challengeLevel.data.tiles = { "$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Terrain/Tiles/ChallengeBuilderDefault.tile" }
	...
	if not data.isLocal then
		if data.inPack then
			topHeader = "$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Overrides/" .. packid .. "."
			header = topHeader .. data.uuid .. "."
		else
			header = "$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Overrides/" .. data.uuid .. "."
			topHeader = header
		end
	else
		if data.inPack then
