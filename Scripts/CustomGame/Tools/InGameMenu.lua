...
function InGameMenu.client_setMode( self, mode )
	if not States then dofile("$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Scripts/Core/Util.lua") end
...
function InGameMenu.client_OpenMenu( self )
    ...
    self.menu = sm.gui.createGuiFromLayout("$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Gui/Layouts/InGameMenu.layout")
    ...
    self.blur = sm.gui.createGuiFromLayout("$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Gui/Layouts/ingame_darken.layout", true, {
        isHud = true,
        isInteractive = false,
        needsCursor = false,
        hidesHotbar = false,
    ...
    self.blur:setImage("BackgroundImage", "$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Gui/t_mapinspectorscreen_gradient.png")
    self.menu:open()
	self.blur:open()
end
