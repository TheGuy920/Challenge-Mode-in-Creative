if _G["ChallengeModeMenuPack_LoadFunctions"] == nil then
    _G["ChallengeModeMenuPack_LoadFunctions"] = function( self )
        ...
        self.ChallengeModeMenuPack_LOADED = function( self, start, force )
            ...
            local local_max = 12
            local uuid_list = sm.json.open("$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Scripts/CustomGame/Json/LocalChallengeList.json").challenges
            for _,c in pairs(sm.json.open("$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Scripts/CustomGame/Json/ChallengeList.json").challenges) do table.insert(uuid_list, c) end
