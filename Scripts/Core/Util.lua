dofile("$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Scripts/CustomGame/ChallengeModeMenuPack.lua")
dofile("$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Scripts/CustomGame/ChallengeModeMenuPlay.lua")
dofile("$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Scripts/CustomGame/ChallengeBuilder.lua")

local header = "$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/"
...
if _G.ChallengeGame == nil then
    dofile("$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Scripts/ChallengeModeScripts/challenge/ChallengeGame.lua")
    InitializeChallengeGame()
end

if _G.ChallengePlayer == nil then
    dofile("$CONTENT_ee7f6b44-e9e8-4636-89ce-e7f5fd41c070/Scripts/ChallengeModeScripts/game/ChallengePlayer.lua")
end
...
if _G.LoadChallengeData == nil then
    _G.LoadChallengeData = function()
        local paths = { { path = header.."Scripts/CustomGame/Json/LocalChallengeList.json", isLocal = true }, { path = header.."Scripts/CustomGame/Json/ChallengeList.json", isLocal = false } }
